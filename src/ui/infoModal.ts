...
/** About info modal. Its title lives inside {@link INFO_MODAL_ABOUT.body} HTML. */
...
<p style="font-family: 'Apercu Pro', sans-serif; margin: 0 0 24px; line-height: 1.6;">The P.A.I.N. project is driven by artist Mary Maggic (Project Lead). The Technical Team consists of Michael Artner (Technical Lead and Back-End Developer), Isra Viadest (Front-End Developer) and Christian Stelmach (Lead on AI Model, Emotional Pain). The Art &amp; Design Team consists of Dominika Kolenda (Data Research, P.A.I.N. Video, Workshop Design), Dora Siafla (Sound), and Hollis Hui (Renderings and Materials Research). From the Ludwig Boltzmann Institute, Open Innovation in Science Center, Mathieu Mahve-Beydokhti (OIS Expert) is appointed as the Lead Facilitator. From the Ludwig Boltzmann Institute for Network Medicine, the team includes Ines Gerard-Ursin (Lead on Data Harmonization, Physical Pain), Iker Núñez-Carpintero (Multiplex Systems Expert) and Norbert Unfug and Sebastian Pirch (Data Visualization).</p>
<p style="font-family: 'Apercu Pro', sans-serif; margin: 0 0 32px; line-height: 1.6;">The collective formed during the "Impact Initiative on AI, Art, and Health" hackathon, organized by JKU Linz and Ars Electronica in 2025.</p>
<div style="display: flex; justify-content: center; gap: 16px; align-items: center; background: white; padding: 16px 36px; margin: 0 -36px -28px; border-radius: 0 0 20px 20px;">
  <div class="info-modal__logos-inner" style="display: flex; flex-wrap: nowrap; gap: 16px; align-items: center; justify-content: center; max-width: 70%; width: 100%;">
...
/** Layer descriptions and attribution from IsraViadest/pain-frontend. */
...
<img class="info-modal__layer-heading" src="/headers/emo_header.png" alt="Emotional Layer: how we describe pain" loading="lazy">
...
<img class="info-modal__layer-heading" src="/headers/env_header.png" alt="Environmental Layer: the planet's distress" loading="lazy">
...
<img class="info-modal__layer-heading" src="/headers/phys_header.png" alt="Physical Layer: pain in our bodies" loading="lazy">
...
<img class="info-modal__layer-heading" src="/headers/socioeco_header.png" alt="Socioeconomic Layer: wealth and hardship" loading="lazy">
<p>The current map uses <a href="https://api.worldbank.org/v2/country/all/indicator/NY.GDP.PCAP.CD?date=2024&amp;format=json&amp;per_page=20000" target="_blank" rel="noopener noreferrer">World Bank GDP per capita for 2024</a>, measured in current US dollars per person. An inverted logarithmic scale gives lower GDP per person a brighter yellow signal. This is an artistic proxy for socioeconomic pain, not a direct measure of individual wealth or suffering. The data are licensed under CC BY 4.0.</p>
<p>The original total-GDP layer uses each country's GDP (the size of its economy), drawn from the <a href="https://datacatalog.worldbank.org/search/dataset/0038130/gdp-ranking" target="_blank" rel="noopener noreferrer">World Bank's GDP rankings</a>. Because the gap between the richest and poorest countries is so vast (the difference between trillions and millions), the project uses a logarithmic scale so that smaller economies aren't swallowed up by giant ones. This is represented as country-based data on a <strong>choropleth scale from transparent to light yellow.</strong> Lighter shades indicate poorer countries and greater levels of pain.</p>
`.trim(),
};
