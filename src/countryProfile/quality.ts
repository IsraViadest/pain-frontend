...
const PROFILES = {
  // The restored full surface uses about 75 MiB including reserved rebuild scratch.
  light: { capacity: 16_384, detail: "split1", samples: 16, fraction: 0.25, budgetBytes: 96 * 1024 ** 2 },
